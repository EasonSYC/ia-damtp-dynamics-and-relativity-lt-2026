...
\begin{proposition}[Gravitational Force]
    ...
    \[
        \boxed{\vm{F} = - \grad V = - G M m \frac{\vm{x} - \vm{x}_0}{\abs{\vm{x} - \vm{x}_0}^2}.}
    \]
\end{proposition}
...
\begin{proof}
    ...
    \begin{align*}
        \PartialOp{x_i} \para{\abs{\vm{x} - \vm{x}_0}^2} &= \PartialOp{x_i} \para{\para{\vm{x} - \vm{x}_0}_j \para{\vm{x} - \vm{x}_0}_j} \\
    ...
    \[
        \PartialOp{x_i} \para{\abs{\vm{x} - \vm{x}_0}^2} = \boxed{2 \abs{\vm{x} - \vm{x}_0} \PartialOp{x_i} \abs{\vm{x} - \vm{x}_0}}
    \]

    Hence,
    \[
        \PartialOp{x_i} \abs{\vm{x} - \vm{x}_0} = \frac{\para{\vm{x} - \vm{x}_0}_i}{\abs{\vm{x} - \vm{x}_0}},
    \]
    so
    \[
        \grad \abs{\vm{x} - \vm{x}_0} = \frac{\vm{x} - \vm{x}_0}{\abs{\vm{x} - \vm{x}_0}}.
    \]

    Hence, the gravitational force is given by
    \[
        \vm{F} = - \grad V = - G M m \frac{\vm{x} - \vm{x}_0}{\abs{\vm{x} - \vm{x}_0}^2}.
    \]    
\end{proof}
...
\[
    \boxed{\phi = \frac{Q}{4 \pi \epsilon_0} \cdot \frac{1}{\abs{\vm{x} - \vm{x}_0}},}
\]
